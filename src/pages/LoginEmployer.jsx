...
export default function LoginEmployer() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // บันทึกข้อมูล User ลง LocalStorage (จำลอง Auth)
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-4 py-12 flex flex-col md:flex-row items-center gap-16 min-h-[calc(100vh-80px-200px)]">
      ...
      <div className="w-full md:w-[400px] bg-[#e8ecf1] rounded-2xl p-8 shadow-sm">
        <h1 className="text-2xl font-bold text-[#1e3a8a] text-center mb-2">{t('loginTitleEmployer')}</h1>
        <p className="text-sm text-gray-700 text-center mb-6">{t('employerLoginSubtitle')}</p>
